...
class OptimizationParams(ParamGroup):
    def __init__(self, parser, max_steps, lr_scaler=1, lr_final_scaler=1, color_lr_scaler=1, opacity_lr_scaler=1, scaling_lr_scaler=1, rotation_lr_scaler=1,  color_rest_lr_scaler=1):
        ...
        self.feature_rest_lr = (self.feature_lr / 20.0) * color_rest_lr_scaler
